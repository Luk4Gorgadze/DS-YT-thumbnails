...
channel_data['Click_rate'] = np.log1p(channel_data['Views']) / np.log1p(channel_data['Subscribers'])
channel_data.dtypes
...
video_data['Click_rate'] = np.log1p(video_data['Views']) / np.log1p(channel_data['Subscribers'].iloc[0])
